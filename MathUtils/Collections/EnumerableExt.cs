...
namespace MathUtils.Collections
{
    public static class EnumerableExt
    {
        ...
        public static IEnumerable<T> Fold<T>(this IEnumerable<T> lhs, IEnumerable<T> rhs)
        {
        ...
        public static IEnumerable<T> Smash<T>(this IEnumerable<T> lhs, IEnumerable<T> rhs, Func<T,T,T> smasher)
        {
            var lEnumerator = lhs.GetEnumerator();
            var rEnumerator = rhs.GetEnumerator();
            ...
            while (true)
            {
                ...
                yield return smasher(lEnumerator.Current,rEnumerator.Current);
            }
        }
